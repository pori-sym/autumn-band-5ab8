...
[![Deploy to Cloudflare](https://deploy.workers.cloudflare.com/button)](https://deploy.workers.cloudflare.com/?url=https://github.com/cloudflare/templates/tree/main/autumn-band-5ab8)
...
```
npm create cloudflare@latest -- --template=cloudflare/templates/autumn-band-5ab8
```

A live public deployment of this template is available at [https://autumn-band-5ab8.templates.workers.dev](https://autumn-band-5ab8.templates.workers.dev)
